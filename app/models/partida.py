...
class Partida(db.Model):
    ...
    id_competicao = db.Column(db.Integer, db.ForeignKey('competicoes.id_competicao'), nullable=False)
    estadio = db.Column(db.String(100), nullable=False)
    local = db.Column(db.String(100), nullable=False)
    equipe_casa_id = db.Column(db.Integer, db.ForeignKey('equipes.id_equipe'), nullable=False)
    equipe_visitante_id = db.Column(db.Integer, db.ForeignKey('equipes.id_equipe'), nullable=False)
    ...
    arbitragem = db.relationship('ArbitragemPartida', back_populates='partida')
    eventos = db.relationship('EventosPartida', back_populates='partida') 
